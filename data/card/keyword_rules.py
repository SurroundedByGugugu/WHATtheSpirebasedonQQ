...
def check_card_play_conditions(game_state, card, play_reason="normal"):
    ...
    for condition in conditions:
        ...
        if op == "active_zone_in":
            ...
            if current_element not in required_elements:
                return False, "【{}】不能被打出：需要当前 Zone 为{}之一，当前为{}。".format(
                    card.name,
