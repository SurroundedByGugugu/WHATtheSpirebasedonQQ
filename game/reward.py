...
CARD_REWARD_POOL = [
    ...
    "card.catalyst",
    "card.concentrate",
    "card.crippling_poison",
    "card.distraction_silent_huntress",
    "card.escape_plan",
    "card.expertise",
    "card.leg_sweep",
    "card.reflex",
    "card.setup_silent_huntress",
    "card.tactician",
    "card.terror",
    "card.a_thousand_cuts",
    "card.after_image",
    "card.envenom",
    ...
    "card.adrenaline",
    "card.bullet_time",
    "card.corpse_explosion",
    "card.doppelganger",
    "card.malaise",
    "card.night_terror",
    "card.phantasmal_killer",
    "card.storm_of_steel",
    "card.venomology",
    "card.burst",
    ...
    "card.living_soil",
    "card.hidden_gravel",
    "card.conglomerate_deconstruction",
    "card.rock_polishing",
